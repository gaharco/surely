 ...
 */
function surely_sanitize_layout($value) {
 ...
 * @return HTML string sanitized with wpkses.
 */
function surely_sanitize_blog_list_view($value) {
 ...
 * @return HTML string sanitized with wpkses.
 */
function surely_sanitize_footer_credit($value) {
	$allowed_tags = array(
						'a' => array(
							'href' => array(),
							'title' => array(),
 ...
 */
function surely_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function surely_sanitize_number_absint( $number, $setting ) {
 ...
 */
function surely_sanitize_image( $image, $setting ) {
	/*
